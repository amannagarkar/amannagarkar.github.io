...
export function ProfileSection({ aboutMe }: ProfileSectionProps) {
  ...
  return (
    <div className="md:sticky top-12 flex flex-row md:flex-col gap-4 md:space-y-8">
      {aboutMe.imageUrl && (
      ...
      <div className="w-2/3 md:w-full">
        ...
        <div className="flex gap-6 mb-6">
          {aboutMe.blogUrl && (
            <a
              ...
              className="group inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-300 transition-colors duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
              <ArrowUpRight
        ...
        <div className="space-y-2">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-zinc-600 hover:text-zinc-600 transition-colors"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Mail size={14} />
